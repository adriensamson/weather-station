...
class BrickMaster extends Device
{
     ...
     * themselves can be set with BrickMaster::setWifiCertificate(). Eap options consist of
     ...
     * 
     *  BrickMaster::CALLBACK_STACK_CURRENT_REACHED, BrickMaster::CALLBACK_STACK_VOLTAGE_REACHED, BrickMaster::CALLBACK_USB_VOLTAGE_REACHED
     * 
     * are triggered, if the thresholds
     * 
     *  BrickMaster::setStackCurrentCallbackThreshold(), BrickMaster::setStackVoltageCallbackThreshold(), BrickMaster::setUSBVoltageCallbackThreshold()
     * 
     * keep being reached.
     * 
