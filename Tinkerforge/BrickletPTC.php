...
class BrickletPTC extends Device
{
     ...
     * 
     *  BrickletPTC::CALLBACK_TEMPERATURE_REACHED, BrickletPTC::CALLBACK_RESISTANCE_REACHED
     * 
     * is triggered, if the threshold
     * 
     *  BrickletPTC::setTemperatureCallbackThreshold(), BrickletPTC::setResistanceCallbackThreshold()
     * 
     * keeps being reached.
     * 
