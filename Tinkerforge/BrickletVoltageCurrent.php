...
class BrickletVoltageCurrent extends Device
{
     ...
     * 
     *  BrickletVoltageCurrent::CALLBACK_CURRENT_REACHED, BrickletVoltageCurrent::CALLBACK_VOLTAGE_REACHED, BrickletVoltageCurrent::CALLBACK_POWER_REACHED
     * 
     * are triggered, if the thresholds
     * 
     *  BrickletVoltageCurrent::setCurrentCallbackThreshold(), BrickletVoltageCurrent::setVoltageCallbackThreshold(), BrickletVoltageCurrent::setPowerCallbackThreshold()
     * 
     * keep being reached.
     * 
